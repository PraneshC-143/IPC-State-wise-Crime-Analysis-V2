...
def _import_root_utils():
    ...
    This function uses importlib to dynamically load the root utils.py module
    without causing a circular import error when the utils package is initialized.
    ...
    Returns:
        module: The loaded root utils module
    
    Raises:
        ImportError: If utils.py cannot be found or loaded
    """
